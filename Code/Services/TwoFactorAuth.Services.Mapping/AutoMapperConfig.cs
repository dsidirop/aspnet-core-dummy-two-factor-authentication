namespace TwoFactorAuth.Services.Mapping
{
    ...
    static public class AutoMapperConfig
    {
        ...
        static public IMapper MapperInstance { get; set; }

        static public void RegisterMappings(params Assembly[] assemblies)
        {
            if (_initialized)
            {
                return;
        ...
        static private IEnumerable<TypesMap> GetFromMaps(IEnumerable<Type> types)
        {
        ...
        static private IEnumerable<TypesMap> GetToMaps(IEnumerable<Type> types)
        {
        ...
        static private IEnumerable<IHaveCustomMappings> GetCustomMappings(IEnumerable<Type> types)
        {
